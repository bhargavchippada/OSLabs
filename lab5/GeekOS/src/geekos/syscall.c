...
/*
 * Get the time of day.
 * Sets the value of xyz to g_numTicks
 */
...
/*
 * Returns the number of syscalls by this process
 */
static int Sys_SysCount(struct Interrupt_State *state __attribute__ ((unused))) {
    return CURRENT_THREAD->syscallsCount;
}
